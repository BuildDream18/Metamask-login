...
class ArtworkController extends Controller
{
    ...
    {	
        ...
        $type = $request->type;
        if($type)
            $artworks = Artwork::where('type', $type)->get();
        else
        {
        ...
        $nav_type = '1';
        return view('artworks', compact("artworks", "nav_type", "type", "firstbidtimes"));
    }
    ...
    {	
        ...
        $nav_type = "1";
        $type = "0";
        return view('artworkById', compact("artwork", "bids", "nav_type", "type"));
    }
